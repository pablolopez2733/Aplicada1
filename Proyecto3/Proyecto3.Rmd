...
Ahora validémosla también mediante el método visto en clase:
Recordemos que podemos estimar la $n$ mediante:

$$n =  \left \lceil{\frac{m}{1+\frac{m-1}{N}}}\right \rceil $$
Donde:
* $m = \frac{1}{4} Z_{\alpha / 2}^{2}$   
* Según Eurostat, la población total de México ($N$) es de 126,200,000
* Utilizaremos $\epsilon = .05$
* consistentes con lo sugerido por el INEGI, utilizaremos $\alpha = .1$
...
n <- ceiling((qnorm(0.95)*sqrt(10000)*126200000)^2/(100^2 + (qnorm(0.95)^2*10000*126200000)))
...
Elección de CDMX y calibramos por municipio:
